...
@class XLsn0wCycleImg;

@protocol XLsn0wCycleImgDelegate <NSObject>

@optional

/** 点击图片回调 */
- (void)cycle:(XLsn0wCycleImg *)cycle didSelectItemAtIndex:(NSInteger)index;

/** 图片滚动回调 */
- (void)cycle:(XLsn0wCycleImg *)cycle didScrollToIndex:(NSInteger)index;

@end

@interface XLsn0wCycleImg : UIView
...
@property (nonatomic, weak) id<XLsn0wCycleImgDelegate> delegate;

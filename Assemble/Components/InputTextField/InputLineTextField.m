...
#import "InputLineTextField.h"

static NSString * const PlacerholderColorKeyPath = @"_placeholderLabel.textColor";

@interface InputLineTextField ()

@property (strong,nonatomic)  UILabel *placeholderlabel;

@end

@implementation InputLineTextField {
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetFillColorWithColor(context, AppThemeColor.CGColor);
...
- (void)initConfig {
    ...
    self.textColor = HexColor(@"#494949");
    self.font = [UIFont systemFontOfSize:14];
    
//    _selectBorderColor=_defaultBorderColor;
    self.placeholderColor= [UIColor xlsn0w_hexString:@"#BABABA"];

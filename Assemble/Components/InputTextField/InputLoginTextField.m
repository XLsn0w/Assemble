...
#import "InputLoginTextField.h"

static NSString * const PlacerholderColorKeyPath = @"_placeholderLabel.textColor";

@interface InputLoginTextField ()

@property (strong,nonatomic)  UILabel *placeholderlabel;

@end

@implementation InputLoginTextField {
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetFillColorWithColor(context, App5AlphaWhiteColor.CGColor);
...
-(void)dealloc{
    ...
    NSLog(@"InputLoginTextField-文本框释放");
}

...
#import "InputRegisterTextField.h"

static NSString * const PlacerholderColorKeyPath = @"_placeholderLabel.textColor";

@interface InputRegisterTextField ()

@property (strong,nonatomic)  UILabel *placeholderlabel;

@end

@implementation InputRegisterTextField {
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetFillColorWithColor(context, HexColor(@"#E6E6E6").CGColor);
...
//    _selectBorderColor=_defaultBorderColor;
    self.placeholderColor= HexColor(@"#848484");

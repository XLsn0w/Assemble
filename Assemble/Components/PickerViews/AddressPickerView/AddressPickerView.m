...
+ (void)showAddressPickerWithShowType:(BRAddressPickerMode)showType
                      ...
                      defaultSelected:(NSArray *)defaultSelectedArr
                         isAutoSelect:(BOOL)isAutoSelect
                          ...
                          resultBlock:(BRAddressResultBlock)resultBlock
                          cancelBlock:(BRAddressCancelBlock)cancelBlock {
    AddressPickerView *addressPickerView = [[AddressPickerView alloc] initWithShowType:showType dataSource:dataSource defaultSelected:defaultSelectedArr isAutoSelect:isAutoSelect themeColor:themeColor resultBlock:resultBlock cancelBlock:cancelBlock];
...
- (void)loadData {
    ...
    if (!self.dataSource || self.dataSource.count == 0) {
        ...
        NSURL *url = [bundle URLForResource:@"AddressPickerView" withExtension:@"bundle"];

...
@interface TextPickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
{
...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    TextPickerView *strPickerView = [[TextPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect themeColor:themeColor resultBlock:resultBlock cancelBlock:cancelBlock];

...
@protocol AlertHUDProtocol <NSObject>

@optional
- (void)hudWasHidden:(AlertHUD *)hud;

@end

typedef enum {
    /** Progress is shown using an UIActivityIndicatorView. This is the default. */
    RQMBProgressHUDModeIndeterminate,
    /** Progress is shown using a round, pie-chart like, progress view. */
    RQMBProgressHUDModeDeterminate,
    /** Progress is shown using a horizontal progress bar */
    RQMBProgressHUDModeDeterminateHorizontalBar,
    /** Progress is shown using a ring-shaped progress view. */
    RQMBProgressHUDModeAnnularDeterminate,
    /** Shows a custom view */
    RQMBProgressHUDModeCustomView,
    /** Shows only labels */
    RQMBProgressHUDModeText
} RQMBProgressHUDMode;

typedef enum {
    /** Opacity animation */
    RQMBProgressHUDAnimationFade,
    /** Opacity + scale animation */
    RQMBProgressHUDAnimationZoom,
    RQMBProgressHUDAnimationZoomOut = RQMBProgressHUDAnimationZoom,
    RQMBProgressHUDAnimationZoomIn
} RQMBProgressHUDAnimation;
 ...
 */
@property (assign) RQMBProgressHUDMode mode;
 ...
 */
@property (assign) RQMBProgressHUDAnimation animationType;
 ...
 */
@property (MB_WEAK) id<AlertHUDProtocol> delegate;
 ...
 */
@interface RQMBRoundProgressView : UIView
 ...
 */
@interface RQMBBarProgressView : UIView
